...
namespace Hooks {
    namespace Detail {
        ...
        struct HookHandlers {
        public:
            static inline TPreHandlers PreHandlers;
            static inline TPostHandlers PostHandlers;
        };
    ...
    private:
        HookInstaller(TPreHandlers&& preHandlers, TPostHandlers&& postHandlers) {
            HookHandlers::PreHandlers = std::move(preHandlers);
            HookHandlers::PostHandlers = std::move(postHandlers);
        }
    };
}
